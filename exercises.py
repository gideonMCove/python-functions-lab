...
print('Exercise 1:', calculateAreaTriangle(10, 5))
...
def apply_discount(price, discount):
     if discount < 0 or discount > 100 :
          print("discount must fall between 0 and 100.")
...
def basicCalculator(a, b, string):
     if string == "add":
          result = a + b
     elif string == "subtract":
          result = a - b
     elif string == "mulitply":
          result = a * b
     elif string == "divide":
          result = a/b
     return (result)

print("Excercise 9:", basicCalculator(10,5,"subtract"))
